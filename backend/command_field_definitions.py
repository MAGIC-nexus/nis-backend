...
command_fields: Dict[str, List[CommandField]] = {
    ...
    "processors": [
        ...
        CommandField(allowed_names=["SubsystemType", "ProcessorContextType", "ProcessorType"], name="subsystem_type", mandatory=False, allowed_values=processor_types, parser=simple_ident, attribute_of=Processor),
        CommandField(allowed_names=["System"], name="processor_system", mandatory=False, allowed_values=None, parser=simple_ident, attribute_of=Processor),
