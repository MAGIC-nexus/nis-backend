...
from backend import Command, regex_var_name, regex_hvar_name, regex_cplex_var
...
commands: List[Command] = [
    ...
    Command(name="shared_elements", allowed_names=["SharedElements"], is_v2=True,
            execution_class_name="backend.command_executors.version2.export_elements_commands.ExportableElementsCommand"),

    Command(name="reused_elements", allowed_names=["ReusedElements"], is_v2=True,
