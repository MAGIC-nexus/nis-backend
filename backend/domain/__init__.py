...
A persisted case study must register sessions. It must register either a sequence of command_executors or a generator of command_executors (an Excel file, an R script). The three possibilities
